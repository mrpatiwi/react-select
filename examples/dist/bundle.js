	...
	filterOptions: function filterOptions(excludeOptions) {
		...
		if (this.props.allowCreate && filterValue) {
			...
			filteredOptions.map(function (option) {
				if (option[_this3.props.labelKey].toLowerCase() === filterValue || option.value.toLowerCase() === filterValue) {
					addNewOption = false;
				}
			});
			if (addNewOption) {
				...
				var newOption = this.props.newOptionCreator ? this.props.newOptionCreator(originalFilterValue) : (_ref = {}, _defineProperty(_ref, this.props.valueKey, originalFilterValue), _defineProperty(_ref, this.props.labelKey, originalFilterValue), _defineProperty(_ref, 'create', true), _ref);
